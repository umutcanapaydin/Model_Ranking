...
> **STATUS: NOT CLOSED** — rows 3 and 4 pending. This wave carries a schema migration, so V3C-78
> auto-escalates it to HIGH: a separate Code-Reviewer **and** Tester, plus a pulled-forward security
> pass. One combined reviewer is not enough here and the tier is not the author's to lower.
