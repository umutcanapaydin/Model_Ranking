...
say "  4. Switch the budget — Cheaper / Mid-priced / Any price, under the"
say "     categories. Does the answer change, and does 'See all N — M fit'"
say "     agree with what you see? This control did not exist until M12-W3;"
say "     the line above it had been written for it a milestone earlier."
