...
6. Ask for approval before finalising. Only then delete the plan document — **the plan never
 lands on the default branch.** The PR stays a draft; the human marks it ready.
