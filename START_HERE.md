...
- **Brand new project** → walk Stage 0 (Bootstrap) with the user. Start with §"Day-0" in [`pipeline-design.md`](https://github.com/SADCAIVibe/General_Pipeline/blob/v4.3.1/general_pipeline_v4.3.1/pipeline-design.md) §12.
...
1. **`AGENTS.md` (a ≤80-line TARGET (currently 145 in this project — aspirational; this file will not pretend otherwise) target, ≤150 hard cap) is canonical.** `CLAUDE.md` is a symlink to it. Industry standard (60k+ public repos use AGENTS.md). Both names work; same file.
...
1. **`AGENTS.md`** (a ≤80-line TARGET (currently 145 in this project — aspirational; this file will not pretend otherwise)) — house rules
...
5. **[`pipeline-design.md`](https://github.com/SADCAIVibe/General_Pipeline/blob/v4.3.1/general_pipeline_v4.3.1/pipeline-design.md)** — full spec (~900 lines; reference, not linear read)
...
2. **Reading [`pipeline-design.md`](https://github.com/SADCAIVibe/General_Pipeline/blob/v4.3.1/general_pipeline_v4.3.1/pipeline-design.md) linearly first.** It's 900 lines; read this orientation + AGENTS.md instead. Reference v2-design as needed.
...
- ❌ A finished product. v2.2 has known gaps documented in [`pipeline-design.md`](https://github.com/SADCAIVibe/General_Pipeline/blob/v4.3.1/general_pipeline_v4.3.1/pipeline-design.md) §15 (several narrowed/closed across v2.1 + v2.2).
