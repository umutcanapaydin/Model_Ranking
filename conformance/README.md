...
## Package-level and project-level rules are covered by PROBES, not by record fixtures 
...
**This distinction was learned the hard way, twice.** The Quality seat once found `P2`/`P3` were
**structurally unreachable** from `--self-test` — the two rules the validator was most credited with
were never asserted, whatever the fixture count. A later attempt at covering `M3` and `C2a`
